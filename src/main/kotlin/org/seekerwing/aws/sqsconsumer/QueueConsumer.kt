 ...
 * implementation of [org.seekerwing.aws.sqsconsumer.MessageProcessor] to process the message and then delete the
 * message from the [org.seekerwing.aws.sqsconsumer.model.Queue]. Users need to invoke [QueueConsumer.stop] to stop the
 * process of polling processing and deleting the message.
 */
