 ...
 * of [QueueConsumerBuilder][org.seekerwing.aws.sqsconsumer.builder.QueueConsumerBuilder] to build a [QueueConsumer]
 * and then invoke [QueueConsumer.start] to start the process of polling
 * [Queue][org.seekerwing.aws.sqsconsumer.model.Queue].
